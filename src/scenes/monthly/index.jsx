...
const Monthly = () => {
    ...
    const [formattedData] = useMemo(() => {
        ...
        const totalUnitsLine = {
            id: "totalUnits", color: theme.palette.secondary[600], data: []
        };
    ...
    return (<Box m={"1.5rem 2.5rem"}>
        <Header title={"MONTHLY SALES"} subtitle={"Monthly Sales of the Products"}/>
        <Box height={"75vh"}>
            {data ? <ResponsiveLine
                data={formattedData}
                theme={{
                    axis: {
                        domain: {
                            ...
                            line: {
                                stroke: theme.palette.secondary[200], strokeWidth: 1,
                            }, text: {
                                fill: theme.palette.secondary[200]
                            }
                        }
